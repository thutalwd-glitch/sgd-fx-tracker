...
This project was built with the assistance of [Claude](https://claude.ai) (Anthropic's AI assistant), which helped with setting up the GitHub Actions automation and the coding of chart designs. 
